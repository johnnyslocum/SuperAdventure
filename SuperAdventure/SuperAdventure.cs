...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.Text += "You completed the '" + newLocation.QuestAvailableHere.Name + "' quest." +
                                                Environment.NewLine;
        ...
        private void UpdateInventoryListUI()
        {
            ...
            dgvInventory.Columns[0].Name = "Inventory Item";
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            int damageToMonster = Engine.RandomNumberGenerator.NumberBetween(currentWeapon.MinimumDamage,
